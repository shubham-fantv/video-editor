...
export default function Navbar() {
  ...
  return (
    <div
      ...
      className="pointer-events-none absolute left-2 right-5 top-0 z-[205] flex h-[72px] items-center px-2"
    >
      <div className="pointer-events-auto flex h-14 items-center gap-2">
        <div className="flex h-12 w-12 items-center justify-center rounded-md bg-background hidden">
      ...
      <div className="pointer-events-auto flex h-14 items-center justify-end gap-2">
        <div className="flex h-12 items-center gap-2 rounded-md bg-background px-2.5">
          <Button
            className="flex gap-2 border border-border hidden"
  ...
  if (!user) {
    return (
      <Button
        ...
        className="flex h-8 gap-1 hidden"
        variant="default"
      >
        Sign in
      </Button>
